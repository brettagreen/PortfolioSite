...
function Resume() {
    return(
        <div id="resumedisplay">
            ...
            Modules include learning resources, practice exercises, projects, and
            career-related coursework.</li>
            <li>Web development, JavaScript, Event Driven Programming,
            Git/Terminal/Github, Modern JavaScript and Testing, jQuery, ReactJS,
            ...
            stack of RHELinux, python, and MySql. </li>
            <li>SFTP Managed File Transfer - administration and configuration - for
            internal and external clients with understanding of best security
            practices, including OpenPGP, SSH, and other encryption protocols.</li>
            <li>Java application programming for internally facing applications that
            use the enterprise service bus.</li>
